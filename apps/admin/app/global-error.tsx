    ...
    <html lang="en">
      <body className="flex min-h-screen items-center justify-center bg-slate-950 px-6 text-white">
        <div className="max-w-xl rounded-3xl border border-white/10 bg-white/5 p-8 text-center shadow-2xl shadow-slate-950/30">
          <div className="text-xs uppercase tracking-[0.3em] text-cyan-200/60">Fatal error</div>
          <h1 className="mt-3 text-2xl font-semibold">Application could not start.</h1>
