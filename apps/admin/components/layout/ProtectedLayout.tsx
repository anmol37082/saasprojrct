...
export default function ProtectedLayout({ children }: ProtectedLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top_left,_rgba(56,189,248,0.15),_transparent_32%),linear-gradient(180deg,_#0b1020_0%,_#0f172a_100%)] text-slate-50">
      <Navbar />
      <div className="mx-auto flex w-full max-w-7xl gap-4 px-4 py-5 lg:py-6">
        <Sidebar />
        <main className="w-full min-w-0 rounded-[1.75rem] border border-white/10 bg-white/5 p-4 shadow-2xl shadow-slate-950/30 backdrop-blur-xl md:p-6">
          {children}
        </main>
      </div>
    </div>
